classtype = function(node) {
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        tbar: [
            { text: '增加', iconCls: 'icon-add', hidden: levels.add, handler: function() { url = '/baseset/classtypeadd'; form.getForm().reset(); win.setTitle('增加' + node.text); win.show(); } },
