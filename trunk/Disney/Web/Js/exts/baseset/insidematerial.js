insidematerial = function(node) {
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        tbar: [
            { text: '增加', iconCls: 'icon-add', hidden: levels.add, handler: function() { url = '/baseset/insidematerialadd'; form.getForm().reset(); win.setTitle('增加' + node.text); win.show(); } },
            ...
            { text: "编辑", iconCls: 'icon-edit', ref: '../appeditBtn', disabled: true, hidden: levels.edit,
                handler: function() {
                    ...
                    win.show();
                    url = '/baseset/insidematerialedit';
                ...
                handler: function() {
                    ...
                    Ext.MessageBox.show({ title: '提示框', msg: '你确定要删除吗?', buttons: Ext.MessageBox.OKCANCEL, icon: Ext.MessageBox.WARNING,
                        fn: function(btn) {
                            if (btn == 'ok') {
                                Ext.Ajax.request({
                                    url: '/baseset/insidematerialdelete',
                                    params: { id: ids },
