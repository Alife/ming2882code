costume = function(node) {
    ...
    var cm = new Ext.grid.ColumnModel([
        ...
        { header: '编号', tooltip: "编号", width: 80, dataIndex: 'Code', sortable: true },
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        tbar: [
            { text: '增加', iconCls: 'icon-add', hidden: levels.add, handler: function() { url = '/baseset/costumeadd'; form.getForm().reset(); win.setTitle('增加' + node.text); win.show(); } },
    ...
    var form = new Ext.form.FormPanel({
        ...
        items: [
                ...
                { xtype: 'textfield', name: 'Code', fieldLabel: '编号', width: 80, allowBlank: false },
