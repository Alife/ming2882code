custom = function(node) {
    ...
    var frmid = '_' + node.id;
    var url = '';
    var query = { limit: 20, keyword: '', provinceID: 0, countryID: 0, deptID: 0, type: 6 };
    ...
    var shengStore = new Ext.data.JsonStore({
        ...
        listeners: {
            load: function() {
                ...
                shengCombox.setValue(32);
                frmshengCombox.setValue(32);
            }
        }
    });
    ...
    var frmdeptStoreCombo = new Ext.form.ComboBox({ mode: 'local', triggerAction: 'all', forceSelection: true, editable: false,
        allowBlank: false, emptyText: '---请选择---', fieldLabel: '业务负责人', name: 'DepartmentID', hiddenName: 'DepartmentID', displayField: 'Name', valueField: 'ID', width: 120,
        store: deptStore
    });
    //所属部门下拉框结束
    ...
    var typeCmb = new Ext.form.ComboBox({ mode: 'local', triggerAction: 'all', forceSelection: true, editable: false,
        allowBlank: false, emptyText: '---请选择---', fieldLabel: '园所类型', name: 'TypeID', hiddenName: 'TypeID', displayField: 'Name', valueField: 'ID', width: 120,
        store: typeStore
    });
        ...
        items: {
            ...
            items: [{
                ...
                items: [
                    ...
                    { xtype: 'textfield', name: 'UserName', fieldLabel: '登录账号', width: '113', allowBlank: false, invalidText: "登录账号已经存在",
                        validator: function() {
                            var code = form.getForm().getValues().UserName;
                            if (code != '') {
                                var oldcode = '';
                                if (url == editurl)
                                    oldcode = grid.getSelectionModel().getSelected().data.UserName;
                    ...
                    { xtype: 'textfield', name: 'Password', fieldLabel: '密码', inputType: 'password', width: '113' },
                    frmdeptStoreCombo, typeCmb,
                    { xtype: 'textfield', name: 'TrueName', fieldLabel: '园所名称', width: '113', allowBlank: false },
                    { xtype: 'textfield', name: 'Mobile', fieldLabel: '园所电话', width: '113', invalidText: "园所电话已经存在",
                        validator: function() {
                    ...
                    { xtype: 'textfield', name: 'LinkMan', fieldLabel: '联络人', width: '113' },
    ...
    function loadedit() {
        ...
        if (levels.edit) {
            ...
            frmshengCombox.readOnly = true;
            frmshiCombox.readOnly = true;
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        tbar: [
                    { text: '增加', iconCls: 'icon-add', hidden: levels.add,
                        handler: function() {
                            ...
                            frmdeptStoreCombo.setValue(10);
                            typeCmb.setValue(7);
                            frmshiCombox.setValue(375);
                            win.show();
                            //frmshiStore.removeAll();
                        }
        ...
        columns: [
                ...
                { header: '园所编号', tooltip: '园所编号', width: 100, dataIndex: 'UserCode', sortable: true },
                { header: '登录账号', tooltip: '登录账号', width: 100, dataIndex: 'UserName', sortable: true },
                { header: '园所名称', tooltip: '园所名称', width: 150, id: 'TrueName', dataIndex: 'TrueName', sortable: true },
                { header: '业务负责人', tooltip: '业务负责人', width: 100, dataIndex: 'DeptName', sortable: true },
                { header: '类型', tooltip: '类型', width: 100, dataIndex: 'TypeName', sortable: true, hidden: true },
                ...
                { header: '园所状态', tooltip: '园所状态', width: 80, dataIndex: 'IsClose', sortable: true, renderer: function(v) { if (v) return '注销'; else return '正常' } }],
    ...
    var searchPanel = new Ext.Panel({
        ...
        tbar: [
                '&nbsp;园所名称/编号：', { xtype: "textfield", name: 'keyword', id: 'keyword' + frmid, width: 120 },
                '&nbsp;所在省：', shengCombox,
                '&nbsp;所在市：', shiCombox,
                '-',
                {
