staff = function(node) {
    ...
    var frmid = '_' + node.id;
    var url = '';
    var query = { limit: 20, keyword: '', provinceID: 0, countryID: 0, deptID: '', type: '1,7' };
    ...
    var jgshengCombox = new Ext.form.ComboBox({ mode: 'local', triggerAction: 'all', forceSelection: true, editable: false,
        blankText: '必须选择!', emptyText: '---请选择---', fieldLabel: '所在省份', name: 'ProvinceID',
        hiddenName: 'ProvinceID', displayField: 'Name', valueField: 'ID', width: 120, store: shengStore,
        listeners: {
            'select': function(combo, record) {
                var id = record.get('ID');
    ...
    var jgshiCombox = new Ext.form.ComboBox({ mode: 'local', triggerAction: 'all', forceSelection: true, editable: false,
        blankText: '必须选择!', emptyText: '---请选择---', fieldLabel: '所在城市', name: 'BirthPlace',
    ...
    var frmdeptStoreCombo = new Ext.form.ComboBox({ mode: 'local', triggerAction: 'all', forceSelection: true, editable: false,
        emptyText: '---请选择---', fieldLabel: '所属部门', name: 'DepartmentID', hiddenName: 'DepartmentID', displayField: 'Name', valueField: 'ID', width: 120,
        store: frmdeptStore
    });
    //所属部门下拉框结束
    ...
    var typeCmb = new Ext.form.ComboBox({ mode: 'local', triggerAction: 'all', forceSelection: true, editable: false,
        allowBlank: false, emptyText: '---请选择---', fieldLabel: '员工类型', name: 'TypeID', hiddenName: 'TypeID', displayField: 'Name', valueField: 'ID', width: 120,
        store: typeStore
    });
        ...
        items: {
            ...
            items: [{
                ...
                items: [
                    ...
                    { xtype: 'textfield', name: 'Duty', fieldLabel: '职位', width: '113' },
    ...
    var searchPanel = new Ext.Panel({
        ...
        tbar: [
                '&nbsp;员工姓名/编号：', { xtype: "textfield", name: 'keyword', id: 'keyword' + frmid, width: 120 },
                '&nbsp;所在省：', shengCombox,
                '&nbsp;所在市：', shiCombox,
                '&nbsp;所属部门：', deptStoreCombo, '-',
                {
