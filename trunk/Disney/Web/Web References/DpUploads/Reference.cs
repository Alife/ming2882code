...
namespace Web.DpUploads {
    ...
    public partial class Uploads : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public bool UploadFile([System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] fs, string fileName, int photoType) {
        ...
        /// <remarks/>
        public void UploadFileAsync(byte[] fs, string fileName, int photoType) {
            this.UploadFileAsync(fs, fileName, photoType, null);
        }
        
        /// <remarks/>
        public void UploadFileAsync(byte[] fs, string fileName, int photoType, object userState) {
