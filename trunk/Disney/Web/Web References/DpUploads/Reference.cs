...
namespace Web.DpUploads {
    ...
    public partial class Uploads : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public bool UploadFile([System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] fs, string fileName, string saveFileName, int photoType) {
        ...
        /// <remarks/>
        public void UploadFileAsync(byte[] fs, string fileName, string saveFileName, int photoType) {
            this.UploadFileAsync(fs, fileName, saveFileName, photoType, null);
        }
        
        /// <remarks/>
        public void UploadFileAsync(byte[] fs, string fileName, string saveFileName, int photoType, object userState) {
            ...
            this.InvokeAsync("UploadFile", new object[] {
                        ...
                        fileName,
                        saveFileName,
                        photoType}, this.UploadFileOperationCompleted, userState);
        }
