<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/AdminSite.Master" CodeFile="ShippingAdd.aspx.cs" Inherits="Admin_Orders_ShippingAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="sitemap">
        ...
        當前位置：<span><a href="/admin">管理中心</a></span> &gt; <span><a href="shipping.aspx">配送方式</a></span> &gt;<label>增加配送方式</label>
    </div>
