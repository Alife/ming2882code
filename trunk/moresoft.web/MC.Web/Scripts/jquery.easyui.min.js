...
val = data[map];
var rr = $("input[name=" + field.name + "][type=radio]", form);
$.fn.prop ? rr.prop("checked", false) : rr.attr("checked", false);
var rv = $("input[name=" + field.name + "][type=radio][value=\"" + val + "\"]", form);
$.fn.prop ? rv.prop("checked", true) : rv.attr("checked", true);
var cc = $("input[name=" + field.name + "][type=checkbox]", form);
$.fn.prop ? cc.prop("checked", false) : cc.attr("checked", false);
var cv = $("input[name=" + field.name + "][type=checkbox][value=\"" + val + "\"]", form);
