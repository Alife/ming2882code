            ...
            <tr>
                ...
                <td>
                    <select name="TopType_inf" class="easyui-combobox" multiple="true" panelheight="auto" style="width: 200px;">
                        <option value="news"<%= id > 0 && item.TopType_inf.Contains("news") ? " selected" : string.Empty%>>最新</option>
                        <option value="common"<%= id > 0 && item.TopType_inf.Contains("common") ? " selected" : string.Empty%>>常见(浏览量排序)</option>
                    </select>
